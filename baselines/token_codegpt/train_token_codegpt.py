...
from transformers import get_constant_schedule, GPT2TokenizerFast, GPT2Model, get_linear_schedule_with_warmup
from tqdm import tqdm
from token_codegpt_multi_task import Model
...
def convert_examples_to_features(source, labels, tokenizer, args):
    ...
    return InputFeatures(input_ids, labels, func_labels, num_statements)
...
def main():
    ...
    tokenizer = GPT2TokenizerFast.from_pretrained("microsoft/CodeGPT-small-java-adaptedGPT2")
    xfmr = GPT2Model.from_pretrained("microsoft/CodeGPT-small-java-adaptedGPT2")
