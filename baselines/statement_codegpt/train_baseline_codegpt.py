...
from transformers import get_constant_schedule, GPT2TokenizerFast, GPT2Model, get_linear_schedule_with_warmup, T5Model, T5Config
from tqdm import tqdm
from codegpt_model_multi_task import Model
...
def main():
    ...
    gpt = GPT2Model.from_pretrained("microsoft/CodeGPT-small-java-adaptedGPT2")
    model = Model(gpt, tokenizer, args, hidden_dim=768)
